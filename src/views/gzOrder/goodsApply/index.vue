...
::v-deep .apply-modal-query-panel .form-item-goods-date-no-star.is-required .el-form-item__label::before,
::v-deep .apply-modal-query-panel .form-item-goods-date-no-star.el-form-item--required .el-form-item__label::before,
::v-deep .apply-modal-query-panel .form-item-goods-date-no-star.is-required .el-form-item__label-wrap > .el-form-item__label::before {
  display: none !important;
  content: none !important;
}
...
.gzOrder-goodsApply-page > .mb8 .el-col .el-button,
.gzOrder-goodsApply-page > .mb8 .el-col .el-button--medium,
.gzOrder-goodsApply-page > .mb8 .el-col .el-button.is-plain {
...
.gzOrder-goodsApply-page > .mb8 .el-col .el-button [class*="el-icon"] {
  font-size: 14px !important;
}
</style>
...
.app-container.gzOrder-goodsApply-page .local-modal-content .apply-modal-query-panel .apply-modal-row-third .el-form-item {
  margin-bottom: 0;
  white-space: nowrap;
  display: inline-flex;
  align-items: center;
