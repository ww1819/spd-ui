<template>
  <div class="app-container gzOrder-refund-page">
    ...
    <el-table v-loading="loading" :data="goodsList" class="table-compact"
      ...
      <el-table-column label="制单时间" align="center" prop="goodsDate" width="180" show-overflow-tooltip resizable>
        <template slot-scope="scope">
...
.gzOrder-refund-page > .el-form.query-form-compact .el-row {
  margin-bottom: 8px;
}

.gzOrder-refund-page > .el-form.query-form-compact .el-row:last-child {
  margin-bottom: 0;
}

.gzOrder-refund-page > .el-form.query-form-compact .el-form-item {
  margin-bottom: 0;
}

.gzOrder-refund-page > .el-form.query-form-compact .query-row-left .el-col {
  display: flex;
  flex-wrap: wrap;
  align-items: flex-start;
}

.gzOrder-refund-page > .el-form.query-form-compact .query-row-left .query-item-inline {
...
.gzOrder-refund-page > .el-form.query-form-compact .query-row-left .query-item-inline:last-child {
  margin-right: 0;
}

.gzOrder-refund-page > .el-form.query-form-compact .query-row-left .query-item-inline .el-input {
  width: 180px;
}

.gzOrder-refund-page > .el-form.query-form-compact .query-row-left .query-item-inline .query-select-wrapper {
  width: 180px;
  display: inline-block;
}
...
.gzOrder-refund-page > .el-form.query-form-compact .query-row-left .query-item-inline .el-select {
  width: 150px;
}

.gzOrder-refund-page > .el-form.query-form-compact .query-row-second {
  position: relative;
}

.gzOrder-refund-page > .el-form.query-form-compact .query-row-second .el-form-item {
  white-space: nowrap;
}

.gzOrder-refund-page > .el-form.query-form-compact .query-row-second .el-form-item .el-form-item__content {
  display: flex;
  align-items: center;
  flex-wrap: nowrap;
}

.gzOrder-refund-page > .el-form.query-form-compact .query-row-second .query-status-col {
  position: absolute;
  left: 552px;
  width: auto;
  padding-left: 0;
...
.app-container.gzOrder-refund-page > .el-form.query-form-compact {
...
/* 按钮行：与到货验收一致的紧凑间距与位置 */
.app-container.gzOrder-refund-page > .el-row.button-row-compact {
  margin-top: -8px !important;
...
/* 主明细框（列表表格）：与到货验收一致 */
.app-container.gzOrder-refund-page > .el-table.table-compact {
  margin-top: 0;
  border-radius: 8px;
  box-shadow: 0 2px 12px 0 rgba(0, 0, 0, 0.05);
}

.app-container.gzOrder-refund-page > .el-table.table-compact th {
  background-color: #EBEEF5 !important;
  color: #606266;
  font-weight: 600 !important;
  font-size: 15px !important;
...
.app-container.gzOrder-refund-page > .el-table.table-compact th .cell {
  font-weight: 600 !important;
  font-size: 15px !important;
  font-family: 'Roboto', sans-serif !important;
}

.app-container.gzOrder-refund-page > .el-table.table-compact td {
  padding: 12px 0;
  color: #606266;
  border-bottom: 1px solid #EBEEF5;
}

.app-container.gzOrder-refund-page > .el-table.table-compact tr:hover > td {
  background-color: #F5F7FA !important;
  transition: all 0.3s;
}

/* 主列表滚动条：与到货验收一致 */
.app-container.gzOrder-refund-page > .el-table.table-compact .el-table__body-wrapper::-webkit-scrollbar {
  width: 20px !important;
  height: 12px !important;
}

.app-container.gzOrder-refund-page > .el-table.table-compact .el-table__body-wrapper::-webkit-scrollbar-thumb {
...
.app-container.gzOrder-refund-page > .el-table.table-compact .el-table__body-wrapper::-webkit-scrollbar-track {
