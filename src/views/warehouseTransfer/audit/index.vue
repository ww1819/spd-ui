              ...
              <div class="modal-detail-section apply-modal-table-panel">
                <div class="table-wrapper">
                  ...
                  >
                    ...
                    <el-table-column label="产品编码" align="center" header-align="center" width="150" show-overflow-tooltip resizable>
                      <template slot-scope="scope">
                        <span>{{ (scope.row.material && scope.row.material.code) || '--' }}</span>
                      </template>
                    </el-table-column>
                    <el-table-column label="产品名称" align="left" header-align="center" prop="material.name" width="180" show-overflow-tooltip resizable>
                      <template slot-scope="scope">
...
.app-container.warehouseTransfer-audit-page .apply-pagination-wrap .pagination-summary {
  margin-left: 14px;
  padding-left: 2px;
  font-size: 13px;
  color: #606266;
...
.app-container.warehouseTransfer-audit-page .apply-pagination-wrap .pagination-summary .summary-label {
  font-weight: 600;
  color: #303133;
}
