<template>
  <div class="app-container list-page warehouseTransfer-audit-page">
    ...
    <el-table v-loading="loading" :data="transferList"
              ...
              @selection-change="handleSelectionChange" height="calc(100vh - 340px)" border stripe class="table-compact">
...
export default {
  ...
  data() {
    return {
      ...
      moreSearchTypes: [],
      moreSearchOptions: [
        { label: "调拨单号", value: "billNo" },
        { label: "调出仓库", value: "fromWarehouse" },
        { label: "调入仓库", value: "toWarehouse" }
      ],
      // 总条数
      total: 0,
      // 调拨表格数据
  ...
  computed: {
    ...
    moreSearchStorageKey() {
      return "spd.warehouseTransfer.audit.moreSearchTypes";
    },
  ...
  methods: {
    ...
    moreSearchFieldClass(t) {
      if (['fromWarehouse', 'toWarehouse'].includes(t)) {
...
<style>
/* 调拨审核：与「到货验收」一致的搜索区 + 主表 + 翻页常驻（非 scoped） */
...
.app-container.warehouseTransfer-audit-page > .el-table.table-compact {
  margin-top: 0;
  border-radius: 8px;
  box-shadow: 0 2px 12px 0 rgba(0, 0, 0, 0.05);
}

.app-container.warehouseTransfer-audit-page > .el-table.table-compact th {
...
.app-container.warehouseTransfer-audit-page > .el-table.table-compact th .cell {
  font-weight: 600 !important;
  font-size: 15px !important;
  font-family: 'Roboto', sans-serif !important;
}

.app-container.warehouseTransfer-audit-page > .el-table.table-compact td {
  padding: 12px 0;
  color: #606266;
  border-bottom: 1px solid #EBEEF5;
}

.app-container.warehouseTransfer-audit-page > .el-table.table-compact tr:hover > td {
  background-color: #F5F7FA !important;
  transition: all 0.3s;
}

.app-container.warehouseTransfer-audit-page > .el-table.table-compact .el-table__body-wrapper::-webkit-scrollbar {
  width: 20px !important;
  height: 12px !important;
}

.app-container.warehouseTransfer-audit-page > .el-table.table-compact .el-table__body-wrapper::-webkit-scrollbar-thumb {
...
.app-container.warehouseTransfer-audit-page > .el-table.table-compact .el-table__body-wrapper::-webkit-scrollbar-track {
  background: #f1f1f1 !important;
  border-radius: 10px !important;
