<template>
  <div class="app-container warehouseTransfer-audit-page">
...
.app-container.warehouseTransfer-audit-page > .el-form.query-form-compact {
...
.app-container.warehouseTransfer-audit-page > .el-row.button-row-compact {
