<template>
  <div class="app-container second-profit-loss-report-page">
...
export default {
  ...
  methods: {
    ...
    getList() {
      this.loading = true;
      listProfitLossEntrySummary(this.queryParams).then(response => {
...
.app-container.second-profit-loss-report-page {
  padding-left: 0 !important;
  padding-right: 0 !important;
}

/* 分页行：合计在左、翻页在右，同一行；翻页下方不留白 */
.second-profit-loss-report-page .pagination-wrapper {
...
.second-profit-loss-report-page .pagination-wrapper .pagination-summary {
  flex-shrink: 0;
  font-size: 14px;
  color: #606266;
}
.second-profit-loss-report-page .pagination-wrapper .pagination-summary .summary-label {
  font-weight: 700;
}
.second-profit-loss-report-page .pagination-wrapper .pagination-container {
  margin-top: 0 !important;
  margin-left: auto !important;
  padding: 4px 0 4px 16px !important;
  flex-shrink: 0;
}
.second-profit-loss-report-page .pagination-wrapper .pagination-container .el-pagination {
