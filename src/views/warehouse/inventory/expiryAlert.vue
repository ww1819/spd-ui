<template>
  <div class="app-container list-page first-inventory-page inv-expiry-query">
...
.inv-expiry-query .ctk-list-toolbar .toolbar-more-search .more-search-type,
.inv-expiry-query .ctk-list-toolbar .toolbar-more-search .more-search-type.el-select,
.inv-expiry-query .ctk-list-toolbar .toolbar-more-search .el-select {
  width: 148px !important;
  min-width: 148px !important;
  max-width: 148px !important;
}
.inv-expiry-query .ctk-list-toolbar .toolbar-more-search .el-select > .el-input,
.inv-expiry-query .ctk-list-toolbar .toolbar-more-search .el-select .el-input__inner {
  width: 148px !important;
  max-width: 148px !important;
}
.inv-expiry-query .ctk-list-toolbar .toolbar-more-search .el-select-dropdown {
  min-width: 148px !important;
}
