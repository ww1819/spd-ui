    ...
    <div v-if="open" class="local-modal-mask">
      <div class="local-modal-content">
        ...
        <el-form ref="form" :model="form" :rules="rules" label-width="100px">
          ...
          <el-row :gutter="20">
            <el-col :span="6">
              <el-form-item label="国家医保名称" prop="countryName">
            ...
            <el-col :span="6">
              <el-form-item label="带量采购" prop="isProcure">
                <el-select v-model="form.isProcure" placeholder="请选择带量采购" style="width: 100%">
                  <el-option
                    v-for="dict in dict.type.is_yes_no"
                    :key="dict.value"
                    :label="dict.label"
          ...
          <el-row :gutter="20">
            <el-col :span="6">
              <el-form-item label="重点监测" prop="isMonitor">
                <el-select v-model="form.isMonitor" placeholder="请选择重点监测" style="width: 100%">
                  <el-option
                    v-for="dict in dict.type.is_yes_no"
                    :key="dict.value"
                    :label="dict.label"
            ...
            <el-col :span="6">
              <el-form-item label="是否高值" prop="isGz">
                <el-select v-model="form.isGz" placeholder="请选择是否高值" style="width: 100%">
                  <el-option
                    v-for="dict in dict.type.is_yes_no"
                    :key="dict.value"
                    :label="dict.label"
