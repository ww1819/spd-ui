<template>
  <div class="app-container list-page gz-department-apply-page">
      ...
      <div v-if="open" class="local-modal-mask">
        ...
        <el-row :gutter="10" class="mb8">
          ...
          <div v-show="action">
            ...
            <el-col :span="1.5">
              <el-button type="danger" icon="el-icon-delete" size="small" @click="handleDeleteGzDepApplyEntry">删除</el-button>
            </el-col>
          </div>
...
export default {
  ...
  computed: {
    moreSearchStorageKey() {
      return "spd.gzDepartment.apply.moreSearchTypes";
    },
