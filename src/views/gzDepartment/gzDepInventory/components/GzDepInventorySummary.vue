  ...
  <div class="gz-dep-table-panel">
    <div class="table-container" ref="tablePanel">
      ...
      >
        ...
        <el-table-column label="数量" align="center" prop="totalQty" width="100" show-overflow-tooltip resizable sortable :sort-method="sortByTotalQty"/>
        <el-table-column label="金额" align="center" prop="totalAmt" width="120" show-overflow-tooltip resizable sortable :sort-method="sortByTotalAmt">
          <template slot-scope="scope">
...
export default {
  ...
  methods: {
    ...
    sortByTotalQty(a, b) {
      return this.sortByNum(a, b, r => r.totalQty);
    },
    sortByTotalAmt(a, b) {
