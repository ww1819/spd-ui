...
<!--              <el-button type="primary" icon="el-icon-plus" size="mini" @click="handleAddBasApplyEntry">添加</el-button>-->
        ...
        <el-table :data="basApplyEntryList" :row-class-name="rowBasApplyEntryIndex" @selection-change="handleBasApplyEntrySelectionChange" ref="basApplyEntry">
          <el-table-column type="selection" width="50" align="center" />
          <el-table-column label="序号" align="center" prop="index" width="50"/>
          <el-table-column label="耗材" prop="materialId" width="150">
            <template slot-scope="scope">
              <SelectMaterial v-model="scope.row.materialId" />
            </template>
          </el-table-column>
