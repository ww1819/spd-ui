<template>
  <div class="app-container list-page d-purchase-audit-page" :class="{ 'is-modal-open': open }">
...
export default {
  ...
  computed: {
    ...
    moreSearchStorageKey() {
      return "spd.department.dPurchaseAudit.moreSearchTypes";
    },
  ...
  methods: {
    ...
    fillListTotalAmtFallback(queryParams) {
      ...
      listPurchaseAudit({ ...queryParams, pageNum: 1, pageSize }).then(res => {
...
/* 翻页样式由非 scoped 块覆盖 ruoyi 绝对定位 */
.d-purchase-audit-page .apply-pagination-wrap {
  margin-top: 0 !important;
  margin-bottom: 0;
}
...
.app-container.d-purchase-audit-page > .apply-table-panel > .el-table {
  margin-bottom: 1px;
}

.app-container.d-purchase-audit-page > .apply-table-panel > .el-table th {
  background-color: #EBEEF5 !important;
  color: #606266;
  font-weight: 600 !important;
  font-size: 15px !important;
...
.app-container.d-purchase-audit-page > .apply-table-panel > .el-table th .cell {
  font-weight: 600 !important;
  font-size: 15px !important;
  font-family: 'Roboto', sans-serif !important;
}
...
.app-container.d-purchase-audit-page .apply-table-panel {
  display: flex;
  flex-direction: column;
  background: #fff;
...
.app-container.d-purchase-audit-page .apply-pagination-wrap {
  flex: 0 0 auto;
  margin-top: 0 !important;
...
.app-container.d-purchase-audit-page .apply-pagination-wrap .pagination-summary {
  margin-left: 14px;
  padding-left: 2px;
  font-size: 13px;
  color: #606266 !important;
...
.app-container.d-purchase-audit-page .apply-pagination-wrap .pagination-summary .summary-label {
  font-weight: 600;
  color: #303133 !important;
}

.app-container.d-purchase-audit-page .apply-pagination-wrap .pagination-container {
...
.app-container.d-purchase-audit-page .apply-pagination-wrap .pagination-container .el-pagination {
  position: relative !important;
  right: auto !important;
}

.app-container.d-purchase-audit-page.is-modal-open .apply-pagination-wrap {
  display: none !important;
}
