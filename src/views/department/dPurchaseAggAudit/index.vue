...
export default {
  ...
  computed: {
    moreSearchStorageKey() {
      return "spd.department.dPurchaseAggAudit.moreSearchTypes";
    },
  ...
  watch: {
    '$route.query.purchaseBillNo'(val) {
      if (val) {
        ...
        this.ensurePurchaseBillNoSearchType()
        this.onMoreSearchTypesChange()
        this.getList()
      }
    }
  ...
  methods: {
    ...
    ensurePurchaseBillNoSearchType() {
      if (!(this.moreSearchTypes || []).includes('purchaseBillNo')) {
        this.moreSearchTypes = ['purchaseBillNo'].concat(this.moreSearchTypes || [])
      }
    },
...
/* 搜索区域：与科室申领一致 */
.app-container.d-purchase-agg-audit-page > .el-form.query-form {
  width: 100%;
  max-width: 100%;
  box-sizing: border-box;
  background: #fff;
...
.app-container.d-purchase-agg-audit-page > .el-form.query-form .el-row {
  margin-bottom: 8px;
}

.app-container.d-purchase-agg-audit-page > .el-form.query-form .el-row:last-child {
  margin-bottom: 0;
}

.app-container.d-purchase-agg-audit-page > .el-form.query-form .el-form-item {
  margin-bottom: 0;
}

.app-container.d-purchase-agg-audit-page > .el-form.query-form .query-row-left .el-col {
  display: flex;
  flex-wrap: wrap;
  align-items: flex-start;
}

.app-container.d-purchase-agg-audit-page > .el-form.query-form .query-row-left .query-item-inline {
...
.app-container.d-purchase-agg-audit-page > .el-form.query-form .query-row-left .query-item-inline:last-child {
  margin-right: 0;
}

.app-container.d-purchase-agg-audit-page > .el-form.query-form .query-row-left .query-item-inline .el-input {
  width: 180px;
}

.app-container.d-purchase-agg-audit-page > .el-form.query-form .query-row-left .query-item-inline .query-select-wrapper {
  width: 180px;
  display: inline-block;
}
...
.app-container.d-purchase-agg-audit-page > .el-form.query-form .query-row-left .query-item-inline .el-select {
  width: 180px;
}
...
.app-container.d-purchase-agg-audit-page > .el-form.query-form .query-row-second .el-form-item {
  white-space: nowrap;
}

.app-container.d-purchase-agg-audit-page > .el-form.query-form .query-row-second .el-form-item .el-form-item__content {
  display: flex;
  align-items: center;
  flex-wrap: nowrap;
}
...
/* 翻页：贴近表格；下方不留白（与汇总申购列表一致） */
.d-purchase-agg-audit-page .pagination-bottom-wrap {
  margin-top: 0 !important;
  margin-bottom: 0;
  padding-bottom: 0;
...
::v-deep .d-purchase-agg-audit-page .pagination-bottom-wrap .pagination-container {
  padding: 0 !important;
  margin-top: 0 !important;
}

/* 仅列表主表（勿作用于弹窗内表） */
::v-deep .d-purchase-agg-audit-page > .el-table .el-table__body-wrapper {
  overflow-x: auto !important;
  overflow-y: auto !important;
}

::v-deep .d-purchase-agg-audit-page > .el-table .el-table__body-wrapper::-webkit-scrollbar {
  height: 12px !important;
}

::v-deep .d-purchase-agg-audit-page > .el-table .el-table__body-wrapper::-webkit-scrollbar-thumb {
  height: 12px !important;
  border-radius: 6px;
  background: rgba(0, 0, 0, 0.25) !important;
}

::v-deep .d-purchase-agg-audit-page > .el-table .el-table__body-wrapper::-webkit-scrollbar-track {
...
::v-deep .d-purchase-agg-audit-page > .el-table {
  overflow-x: auto;
}
</style>
...
.app-container.d-purchase-agg-audit-page > .el-table {
  margin-bottom: 1px;
}

.app-container.d-purchase-agg-audit-page > .el-table th {
  background-color: #EBEEF5 !important;
  color: #606266;
  font-weight: 600 !important;
  font-size: 15px !important;
...
.app-container.d-purchase-agg-audit-page > .el-table th .cell {
  font-weight: 600 !important;
  font-size: 15px !important;
  font-family: 'Roboto', sans-serif !important;
}
