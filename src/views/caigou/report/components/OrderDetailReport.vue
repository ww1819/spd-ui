  ...
  <div class="app-container list-page first-inventory-page cg-report-query">
    ...
    <div class="table-container" ref="tablePanel">
      ...
      >
        ...
        <el-table-column label="订单单号" align="left" header-align="center" class-name="ctk-col-left" prop="orderNo" width="200" min-width="180" show-overflow-tooltip resizable />
        <el-table-column label="计划单号" align="left" header-align="center" class-name="ctk-col-left" prop="planNo" width="200" min-width="180" show-overflow-tooltip resizable sortable="custom" :sort-orders="['ascending', 'descending']" />
        ...
        <el-table-column label="数量" align="center" prop="orderQty" width="110" min-width="100" show-overflow-tooltip resizable sortable="custom" :sort-orders="['ascending', 'descending']">
          <template slot-scope="scope">
        ...
        <el-table-column label="金额" align="center" prop="totalAmount" width="130" min-width="120" show-overflow-tooltip resizable sortable="custom" :sort-orders="['ascending', 'descending']">
          <template slot-scope="scope">
...
export default {
  ...
  data() {
    return {
      ...
      sortProp: null,
      sortOrder: null,
      numericSortProps: ["orderQty", "unitPrice", "totalAmount"],
      selectedRowKeys: [],
  ...
  computed: {
    moreSearchStorageKey() {
      return "spd.caigou.report.orderDetail.moreSearchTypes";
    },
  ...
  methods: {
    ...
    moreSearchFieldClass(t) {
      if (['warehouse', 'material'].includes(t)) {
