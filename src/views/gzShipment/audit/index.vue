<template>
  <div class="app-container">
    ...
    <el-table v-loading="loading" :data="shipmentList" @selection-change="handleSelectionChange" height="58vh" border>
    ...
    <transition name="modal-fade">
      <div v-if="open" class="local-modal-mask">
        ...
        >
          ...
          <el-table-column label="备注" prop="remark" width="300" show-overflow-tooltip resizable>
            <template slot-scope="scope">
