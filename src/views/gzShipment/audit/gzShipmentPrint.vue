<template>
  <div class="gz-shipment-print" ref="receiptOrderPrintRef" hidden="hidden">
    <div style="font-size: 22px;text-align: center;">高值出库单</div>
    <div class="summary">
      <div class="col1" style="width:45%">单号: {{ row.shipmentNo }}</div>
      <div class="col1" style="width:30%">仓库: {{ row.warehouseName }}</div>
      <div class="col1" style="width:25%">科室: {{ row.departmentName }}</div>

      <div class="col1" style="width:45%">申请时间: {{ row.shipmentDate }}</div>
