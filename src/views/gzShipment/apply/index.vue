    ...
    <el-row :gutter="10" class="mb8">
      <el-col :span="1.5">
        <el-button
          ...
          size="mini"
          @click="handleAdd"
          v-hasPermi="['gzShipment:apply:add']"
        >新增</el-button>
      </el-col>
      <el-col :span="1.5">
        <el-button
          ...
          size="mini"
          @click="handleExport"
          v-hasPermi="['gzShipment:apply:export']"
        >导出</el-button>
      </el-col>
...
<script>
import { listShipment, getShipment, delShipment, addShipment, updateShipment } from "@/api/gz/shipment";
...
export default {
  ...
  components: {SelectMaterial,SelectWarehouse,SelectDepartment,SelectGzDepotInventory},
  data() {
    return {
      // 遮罩层
      loading: true,
  ...
  methods: {
    ...
    getList() {
      this.loading = true;
      this.queryParams.shipmentStatus = "1";
