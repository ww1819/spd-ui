    ...
    >
      ...
      <div class="info-block" :style="tableStyle">
        <div class="info-grid">
          ...
          <div class="info-cell">
            <span class="info-label info-label--col1">备注</span>
            <span class="info-value">{{ row.remark || '' }}</span>
          </div>
          <div class="info-cell">
            <span class="info-label info-label--col2">制单日期</span>
      ...
      <table class="detail-table" :style="tableStyle">
        ...
        <tbody>
          ...
          <tr v-if="pageIndex === pagedDetailList.length - 1" class="print-total-row">
            <td colspan="8" class="total-label-cell">
      ...
      <div class="sign-block" :style="tableStyle">
        ...
        <div class="sign-item">
          <span class="sign-label">采购员</span>
          <span class="sign-value">{{ row.purchaserName || '' }}</span>
        </div>
      </div>
    </div>
  </div>
