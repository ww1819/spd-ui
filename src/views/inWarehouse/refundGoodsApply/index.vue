<template>
  <div class="app-container list-page inWarehouse-refundGoodsApply-page" :class="{ 'is-modal-open': open }">
      ...
      <div v-if="open" class="local-modal-mask">
          ...
          <div class="list-toolbar-left">
            ...
            <template v-if="action">
              ...
              <el-button
                ...
                class="spd-btn spd-btn--secondary"
                icon="el-icon-ref"
                :disabled="stkIoBillEntryList.length > 0"
                @click="refRkApply"
              >引用入库单</el-button>
              <el-button
                size="small"
        ...
        >
          ...
          <el-table-column label="备注" prop="remark" width="140" min-width="120" show-overflow-tooltip resizable sortable class-name="detail-col-fluid-input">
            <template slot-scope="scope">
              <el-input v-model="scope.row.remark" placeholder="备注" size="small" class="detail-cell-fluid-input" />
            </template>
          </el-table-column>
  ...
  methods: {
    ...
    getList(allowWhenDialog) {
      ...
      listThInventory(queryParams).then(response => {
        ...
        // 后端未返回合计时，拉全量当前筛选结果汇总（最多 5000 条）
...
.app-container.inWarehouse-refundGoodsApply-page .local-modal-content .apply-modal-query-panel .el-form-item.apply-modal-label-required .el-form-item__label {
  color: #f56c6c !important;
}
...
.app-container.inWarehouse-refundGoodsApply-page .local-modal-content .modal-detail-section .el-table td.detail-col-date .cell {
  white-space: normal;
...
.app-container.inWarehouse-refundGoodsApply-page .local-modal-content .modal-detail-section .el-table td.detail-col-date .detail-date-expiry .el-input__prefix,
.app-container.inWarehouse-refundGoodsApply-page .local-modal-content .modal-detail-section .el-table td.detail-col-date .detail-date-expiry .el-input__suffix {
  display: none !important;
}
.app-container.inWarehouse-refundGoodsApply-page .local-modal-content .modal-detail-section .el-table td.detail-col-date .detail-date-expiry .el-input__inner {
  padding-left: 6px !important;
  padding-right: 6px !important;
}

/* 添加入库弹窗：批号列单行输入（列宽不变，输入框铺满单元格） */
.app-container.inWarehouse-refundGoodsApply-page .local-modal-content .modal-detail-section .el-table td.detail-col-batch .cell {
  vertical-align: middle;
  padding-top: 4px;
  padding-bottom: 4px;
  padding-left: 4px;
...
.app-container.inWarehouse-refundGoodsApply-page .local-modal-content .modal-detail-section .el-table td.detail-col-batch .detail-batch-input {
  width: 100% !important;
  max-width: 100% !important;
}
.app-container.inWarehouse-refundGoodsApply-page .local-modal-content .modal-detail-section .el-table td.detail-col-batch .detail-batch-input .el-input__inner {
  padding-left: 6px;
  padding-right: 6px;
}

/* 日期列：有值时隐藏灰色占位符 */
.app-container.inWarehouse-refundGoodsApply-page .local-modal-content .modal-detail-section .el-table .el-date-editor.detail-date-has-value .el-input__inner::placeholder,
.app-container.inWarehouse-refundGoodsApply-page .local-modal-content .modal-detail-section .el-table .el-date-editor.detail-date-has-value .el-input__inner::-webkit-input-placeholder {
  color: transparent !important;
  opacity: 0 !important;
}
.app-container.inWarehouse-refundGoodsApply-page .local-modal-content .modal-detail-section .el-table td.detail-col-begin-date .cell {
  vertical-align: middle;
  padding-top: 4px;
  padding-bottom: 4px;
  padding-left: 4px;
...
.app-container.inWarehouse-refundGoodsApply-page .local-modal-content .modal-detail-section .el-table td.detail-col-begin-date .detail-date-begin .el-input__prefix,
.app-container.inWarehouse-refundGoodsApply-page .local-modal-content .modal-detail-section .el-table td.detail-col-begin-date .detail-date-begin .el-input__suffix {
  display: none !important;
}
.app-container.inWarehouse-refundGoodsApply-page .local-modal-content .modal-detail-section .el-table td.detail-col-begin-date .detail-date-begin .el-input__inner {
  overflow: visible;
  text-overflow: clip;
  padding-right: 6px !important;
}
...
/* 明细表合计行：与表头同高、同色 */
.app-container.inWarehouse-refundGoodsApply-page .local-modal-content .modal-detail-section .el-table.apply-detail-table > .el-table__footer-wrapper,
.app-container.inWarehouse-refundGoodsApply-page .local-modal-content .modal-detail-section .el-table.apply-detail-table .el-table__fixed .el-table__fixed-footer-wrapper,
.app-container.inWarehouse-refundGoodsApply-page .local-modal-content .modal-detail-section .el-table.apply-detail-table .el-table__fixed-right .el-table__fixed-footer-wrapper {
  background-color: #f1f5f9 !important;
  border-bottom: none !important;
}
.app-container.inWarehouse-refundGoodsApply-page .local-modal-content .modal-detail-section .apply-detail-table .el-table__footer-wrapper tr,
.app-container.inWarehouse-refundGoodsApply-page .local-modal-content .modal-detail-section .apply-detail-table .el-table__fixed-footer-wrapper tr {
  height: 38px !important;
}
.app-container.inWarehouse-refundGoodsApply-page .local-modal-content .modal-detail-section .apply-detail-table .el-table__footer-wrapper td,
.app-container.inWarehouse-refundGoodsApply-page .local-modal-content .modal-detail-section .apply-detail-table .el-table__fixed-footer-wrapper td,
.app-container.inWarehouse-refundGoodsApply-page .local-modal-content .modal-detail-section .apply-detail-table .el-table__footer-wrapper td.el-table__cell,
.app-container.inWarehouse-refundGoodsApply-page .local-modal-content .modal-detail-section .apply-detail-table .el-table__fixed-footer-wrapper td.el-table__cell {
  height: 38px !important;
  min-height: 38px !important;
  padding: 6px 0 !important;
  line-height: 24px !important;
...
.app-container.inWarehouse-refundGoodsApply-page .local-modal-content .modal-detail-section .apply-detail-table .el-table__footer-wrapper td .cell,
.app-container.inWarehouse-refundGoodsApply-page .local-modal-content .modal-detail-section .apply-detail-table .el-table__fixed-footer-wrapper td .cell {
  color: #334155 !important;
  font-size: 13px !important;
  font-weight: 600 !important;
  line-height: 24px !important;
...
.app-container.inWarehouse-refundGoodsApply-page .local-modal-content .modal-detail-section .apply-detail-table .el-table__footer-wrapper tr td:first-child,
.app-container.inWarehouse-refundGoodsApply-page .local-modal-content .modal-detail-section .apply-detail-table .el-table__fixed-footer-wrapper tr td:first-child {
  border-left: 1px solid #e2e8f0 !important;
}
.app-container.inWarehouse-refundGoodsApply-page .local-modal-content .modal-detail-section .apply-detail-table .el-table__footer-wrapper tr td:last-child,
.app-container.inWarehouse-refundGoodsApply-page .local-modal-content .modal-detail-section .apply-detail-table .el-table__fixed-footer-wrapper tr td:last-child {
  border-right: 1px solid #e2e8f0 !important;
}
.app-container.inWarehouse-refundGoodsApply-page .local-modal-content .modal-detail-section .apply-detail-table .el-table__footer-wrapper td .cell:empty,
.app-container.inWarehouse-refundGoodsApply-page .local-modal-content .modal-detail-section .apply-detail-table .el-table__fixed-footer-wrapper td .cell:empty {
  padding: 0;
}
.app-container.inWarehouse-refundGoodsApply-page .local-modal-content .modal-detail-section .apply-detail-table .el-table__fixed-footer-wrapper td.el-table-column--selection .cell {
  font-size: 0;
}

/* 批次号：完整展示，自动换行 */
.app-container.inWarehouse-refundGoodsApply-page .local-modal-content .modal-detail-section .el-table td.detail-col-batch-no .cell {
  white-space: normal;
  word-break: break-all;
  vertical-align: middle;
  padding-top: 4px;
...
.app-container.inWarehouse-refundGoodsApply-page .local-modal-content .modal-detail-section .el-table td.detail-col-batch-no .detail-batch-no-cell {
  display: block;
  width: 100%;
  line-height: 1.35;
  word-break: break-all;
...
.app-container.inWarehouse-refundGoodsApply-page .local-modal-content .modal-detail-section .el-table tbody td.el-table__cell {
  padding: 4px 0 !important;
}
.app-container.inWarehouse-refundGoodsApply-page .local-modal-content .modal-detail-section .el-table tbody td {
  vertical-align: middle;
}
.app-container.inWarehouse-refundGoodsApply-page .local-modal-content .modal-detail-section .el-table td.detail-col-text-wrap .cell {
  vertical-align: top;
  text-align: left;
  white-space: normal;
  word-break: break-word;
...
.app-container.inWarehouse-refundGoodsApply-page .local-modal-content .modal-detail-section .el-table td.detail-col-text-wrap .detail-text-cell-2line {
  display: -webkit-box;
...
.app-container.inWarehouse-refundGoodsApply-page .local-modal-content .modal-detail-section .el-table thead th.el-table__cell {
  padding: 6px 0 !important;
}
.app-container.inWarehouse-refundGoodsApply-page .local-modal-content .modal-detail-section .el-table:not(.apply-detail-table) .el-table__footer-wrapper td,
.app-container.inWarehouse-refundGoodsApply-page .local-modal-content .modal-detail-section .el-table:not(.apply-detail-table) .el-table__fixed-footer-wrapper td {
  padding-top: 6px !important;
  padding-bottom: 6px !important;
  background-color: #f8fafc !important;
  border-bottom: 1px solid #e2e8f0 !important;
...
.app-container.inWarehouse-refundGoodsApply-page .local-modal-content.apply-modal-root-content {
  position: relative;
  overflow: hidden;
}
...
.app-container.inWarehouse-refundGoodsApply-page .apply-modal-root-content > .material-filter-mask.material-filter-mask--nested {
  position: absolute;
  left: 0;
  right: -8px;
  top: 0;
...
/* RK-添加明细：标题栏与修改入库一致 */
.app-container.inWarehouse-refundGoodsApply-page .apply-modal-root-content > .material-filter-mask.material-filter-mask--nested .modal-header {
...
.app-container.inWarehouse-refundGoodsApply-page .apply-modal-root-content > .material-filter-mask.material-filter-mask--nested .modal-title {
  font-size: 16px;
  font-weight: 600;
  color: #303133;
  line-height: 1.4;
...
html body .app-container.inWarehouse-refundGoodsApply-page .apply-modal-root-content > .material-filter-mask.material-filter-mask--nested > .local-modal-content.material-filter-modal--nested.apply-inbound-nested-modal {
  height: 100% !important;
  max-height: 100% !important;
  min-height: 0 !important;
}

.app-container.inWarehouse-refundGoodsApply-page .apply-modal-root-content > .material-filter-mask.material-filter-mask--nested > .material-filter-modal--nested {
  width: 100%;
  height: 100%;
  max-height: 100%;
  min-height: 0;
...
.app-container.inWarehouse-refundGoodsApply-page .apply-inbound-nested-modal > .material-filter-form.modal-form-compact {
...
.app-container.inWarehouse-refundGoodsApply-page .apply-inbound-nested-modal .apply-modal-toolbar.list-toolbar {
  margin-top: 4px !important;
  margin-bottom: 4px !important;
...
.app-container.inWarehouse-refundGoodsApply-page .apply-inbound-nested-modal .material-filter-form > .apply-table-panel {
  flex: 1 1 auto;
  min-height: 0;
  margin-bottom: 40px;
}

.app-container.inWarehouse-refundGoodsApply-page .apply-inbound-nested-modal .apply-table-panel > .apply-main-table {
  margin-top: 0;
  flex: 0 0 auto;
...
html body .app-container.inWarehouse-refundGoodsApply-page .apply-inbound-nested-modal .apply-table-panel > .apply-main-table > .el-table__body-wrapper {
  z-index: 2;
  overflow: auto !important;
  overscroll-behavior: contain;
  -webkit-overflow-scrolling: touch;
...
html body .app-container.inWarehouse-refundGoodsApply-page .apply-inbound-nested-modal .apply-table-panel > .apply-main-table > .el-table__body-wrapper::-webkit-scrollbar,
html body .app-container.inWarehouse-refundGoodsApply-page .apply-inbound-nested-modal .apply-table-panel > .apply-main-table .el-table__fixed-body-wrapper::-webkit-scrollbar,
html body .app-container.inWarehouse-refundGoodsApply-page .apply-inbound-nested-modal .apply-table-panel > .apply-main-table .el-table__fixed-right::-webkit-scrollbar,
html body .app-container.inWarehouse-refundGoodsApply-page .apply-inbound-nested-modal .apply-table-panel > .apply-main-table .el-table__fixed::-webkit-scrollbar {
  width: 8px !important;
  height: 12px !important;
}

html body .app-container.inWarehouse-refundGoodsApply-page .apply-inbound-nested-modal .apply-table-panel > .apply-main-table > .el-table__body-wrapper::-webkit-scrollbar:horizontal,
html body .app-container.inWarehouse-refundGoodsApply-page .apply-inbound-nested-modal .apply-table-panel > .apply-main-table .el-table__fixed-body-wrapper::-webkit-scrollbar:horizontal,
html body .app-container.inWarehouse-refundGoodsApply-page .apply-inbound-nested-modal .apply-table-panel > .apply-main-table .el-table__fixed-right::-webkit-scrollbar:horizontal,
html body .app-container.inWarehouse-refundGoodsApply-page .apply-inbound-nested-modal .apply-table-panel > .apply-main-table .el-table__fixed::-webkit-scrollbar:horizontal {
  height: 12px !important;
}

html body .app-container.inWarehouse-refundGoodsApply-page .apply-inbound-nested-modal .apply-table-panel > .apply-main-table > .el-table__body-wrapper::-webkit-scrollbar-track,
html body .app-container.inWarehouse-refundGoodsApply-page .apply-inbound-nested-modal .apply-table-panel > .apply-main-table .el-table__fixed-body-wrapper::-webkit-scrollbar-track,
html body .app-container.inWarehouse-refundGoodsApply-page .apply-inbound-nested-modal .apply-table-panel > .apply-main-table .el-table__fixed-right::-webkit-scrollbar-track,
html body .app-container.inWarehouse-refundGoodsApply-page .apply-inbound-nested-modal .apply-table-panel > .apply-main-table .el-table__fixed::-webkit-scrollbar-track {
  background: #f1f1f1 !important;
  border-radius: 3px !important;
}

html body .app-container.inWarehouse-refundGoodsApply-page .apply-inbound-nested-modal .apply-table-panel > .apply-main-table > .el-table__body-wrapper::-webkit-scrollbar-thumb,
html body .app-container.inWarehouse-refundGoodsApply-page .apply-inbound-nested-modal .apply-table-panel > .apply-main-table .el-table__fixed-body-wrapper::-webkit-scrollbar-thumb,
html body .app-container.inWarehouse-refundGoodsApply-page .apply-inbound-nested-modal .apply-table-panel > .apply-main-table .el-table__fixed-right::-webkit-scrollbar-thumb,
html body .app-container.inWarehouse-refundGoodsApply-page .apply-inbound-nested-modal .apply-table-panel > .apply-main-table .el-table__fixed::-webkit-scrollbar-thumb {
  background: #a8a8a8 !important;
  border-radius: 3px !important;
  border: none !important;
  box-shadow: none !important;
...
html body .app-container.inWarehouse-refundGoodsApply-page .apply-inbound-nested-modal .apply-table-panel > .apply-main-table > .el-table__body-wrapper::-webkit-scrollbar-thumb:hover,
html body .app-container.inWarehouse-refundGoodsApply-page .apply-inbound-nested-modal .apply-table-panel > .apply-main-table .el-table__fixed-body-wrapper::-webkit-scrollbar-thumb:hover,
html body .app-container.inWarehouse-refundGoodsApply-page .apply-inbound-nested-modal .apply-table-panel > .apply-main-table .el-table__fixed-right::-webkit-scrollbar-thumb:hover,
html body .app-container.inWarehouse-refundGoodsApply-page .apply-inbound-nested-modal .apply-table-panel > .apply-main-table .el-table__fixed::-webkit-scrollbar-thumb:hover {
  background: #909090 !important;
}

html body .app-container.inWarehouse-refundGoodsApply-page .apply-inbound-nested-modal .apply-table-panel > .apply-main-table .el-scrollbar__bar.is-horizontal {
  height: 12px !important;
}

/* 明细框与按钮行间距由按钮行 margin-bottom 控制，此处不再负 margin */
.app-container.inWarehouse-refundGoodsApply-page .local-modal-content .apply-modal-table-panel > .table-wrapper > .apply-detail-table {
  border-radius: 10px 10px 0 0;
  box-shadow: none;
  margin-bottom: 0;
}

.app-container.inWarehouse-refundGoodsApply-page .local-modal-content .apply-modal-table-panel > .table-wrapper {
  overflow: hidden;
  border-bottom: none;
}

.app-container.inWarehouse-refundGoodsApply-page .local-modal-content .apply-modal-toolbar.list-toolbar {
  flex: 0 0 auto;
  margin-top: 4px !important;
  margin-bottom: 4px !important;
  margin-left: 0 !important;
...
.app-container.inWarehouse-refundGoodsApply-page .local-modal-content .apply-modal-table-panel {
  margin-left: 0 !important;
  margin-right: 0 !important;
  width: 100% !important;
  max-width: 100% !important;
...
/* 弹窗明细表头：与主列表一致 */
.app-container.inWarehouse-refundGoodsApply-page .local-modal-content .modal-detail-section .apply-detail-table .el-table__header-wrapper th,
.app-container.inWarehouse-refundGoodsApply-page .local-modal-content .modal-detail-section .apply-detail-table .el-table__header-wrapper th.el-table__cell,
.app-container.inWarehouse-refundGoodsApply-page .local-modal-content .modal-detail-section .apply-detail-table .el-table__fixed-header-wrapper th,
.app-container.inWarehouse-refundGoodsApply-page .local-modal-content .modal-detail-section .apply-detail-table .el-table__fixed-header-wrapper th.el-table__cell,
.app-container.inWarehouse-refundGoodsApply-page .local-modal-content .modal-detail-section .apply-detail-table .el-table__fixed-right-header-wrapper th,
.app-container.inWarehouse-refundGoodsApply-page .local-modal-content .modal-detail-section .apply-detail-table .el-table__fixed-right-header-wrapper th.el-table__cell {
  background-color: #f1f5f9 !important;
  color: #334155 !important;
  font-size: 13px !important;
  font-weight: 600 !important;
...
.app-container.inWarehouse-refundGoodsApply-page .local-modal-content .modal-detail-section .apply-detail-table .el-table__header-wrapper th .cell,
.app-container.inWarehouse-refundGoodsApply-page .local-modal-content .modal-detail-section .apply-detail-table .el-table__fixed-header-wrapper th .cell,
.app-container.inWarehouse-refundGoodsApply-page .local-modal-content .modal-detail-section .apply-detail-table .el-table__fixed-right-header-wrapper th .cell {
  color: #334155 !important;
  font-size: 13px !important;
  font-weight: 600 !important;
  text-align: center !important;
...
/* 单据状态列表头不换行 */
.app-container.inWarehouse-refundGoodsApply-page .apply-main-table thead th:nth-child(9) .cell {
  white-space: nowrap !important;
}

/* 序号列表头不换行 */
.app-container.inWarehouse-refundGoodsApply-page .local-modal-content .apply-detail-table thead th:nth-child(2) .cell {
  white-space: nowrap !important;
}

/* 单位列表头不换行 */
.app-container.inWarehouse-refundGoodsApply-page .local-modal-content .apply-detail-table thead th:nth-child(7) .cell {
  white-space: nowrap !important;
}

/* 弹窗明细表滚动条：与到货验收主列表一致（横向 12px，固定粗细） */
.app-container.inWarehouse-refundGoodsApply-page .local-modal-content .modal-detail-section .el-table.apply-detail-table > .el-table__body-wrapper {
  z-index: 2;
  overflow: auto !important;
  overscroll-behavior: contain;
  -webkit-overflow-scrolling: touch;
...
.app-container.inWarehouse-refundGoodsApply-page .local-modal-content .modal-detail-section .el-table.apply-detail-table > .el-table__body-wrapper::-webkit-scrollbar,
.app-container.inWarehouse-refundGoodsApply-page .local-modal-content .modal-detail-section .el-table.apply-detail-table .el-table__fixed-body-wrapper::-webkit-scrollbar,
.app-container.inWarehouse-refundGoodsApply-page .local-modal-content .modal-detail-section .el-table.apply-detail-table .el-table__fixed-right::-webkit-scrollbar,
.app-container.inWarehouse-refundGoodsApply-page .local-modal-content .modal-detail-section .el-table.apply-detail-table .el-table__fixed::-webkit-scrollbar {
  width: 8px !important;
  height: 12px !important;
}

.app-container.inWarehouse-refundGoodsApply-page .local-modal-content .modal-detail-section .apply-detail-table .el-table__body-wrapper::-webkit-scrollbar:vertical,
.app-container.inWarehouse-refundGoodsApply-page .local-modal-content .modal-detail-section .apply-detail-table .el-table__fixed-body-wrapper::-webkit-scrollbar:vertical,
.app-container.inWarehouse-refundGoodsApply-page .local-modal-content .modal-detail-section .apply-detail-table .el-table__fixed-right::-webkit-scrollbar:vertical,
.app-container.inWarehouse-refundGoodsApply-page .local-modal-content .modal-detail-section .apply-detail-table .el-table__fixed::-webkit-scrollbar:vertical {
  width: 8px !important;
}

.app-container.inWarehouse-refundGoodsApply-page .local-modal-content .modal-detail-section .apply-detail-table .el-table__body-wrapper::-webkit-scrollbar:horizontal,
.app-container.inWarehouse-refundGoodsApply-page .local-modal-content .modal-detail-section .apply-detail-table .el-table__fixed-body-wrapper::-webkit-scrollbar:horizontal,
.app-container.inWarehouse-refundGoodsApply-page .local-modal-content .modal-detail-section .apply-detail-table .el-table__fixed-right::-webkit-scrollbar:horizontal,
.app-container.inWarehouse-refundGoodsApply-page .local-modal-content .modal-detail-section .apply-detail-table .el-table__fixed::-webkit-scrollbar:horizontal {
  height: 12px !important;
}

.app-container.inWarehouse-refundGoodsApply-page .local-modal-content .modal-detail-section .apply-detail-table .el-table__body-wrapper::-webkit-scrollbar-track,
.app-container.inWarehouse-refundGoodsApply-page .local-modal-content .modal-detail-section .apply-detail-table .el-table__fixed-body-wrapper::-webkit-scrollbar-track,
.app-container.inWarehouse-refundGoodsApply-page .local-modal-content .modal-detail-section .apply-detail-table .el-table__fixed-right::-webkit-scrollbar-track,
.app-container.inWarehouse-refundGoodsApply-page .local-modal-content .modal-detail-section .apply-detail-table .el-table__fixed::-webkit-scrollbar-track {
  background: #f1f1f1 !important;
  border-radius: 3px !important;
}

.app-container.inWarehouse-refundGoodsApply-page .local-modal-content .modal-detail-section .el-table.apply-detail-table > .el-table__body-wrapper::-webkit-scrollbar-thumb,
.app-container.inWarehouse-refundGoodsApply-page .local-modal-content .modal-detail-section .el-table.apply-detail-table .el-table__fixed-body-wrapper::-webkit-scrollbar-thumb,
.app-container.inWarehouse-refundGoodsApply-page .local-modal-content .modal-detail-section .el-table.apply-detail-table .el-table__fixed-right::-webkit-scrollbar-thumb,
.app-container.inWarehouse-refundGoodsApply-page .local-modal-content .modal-detail-section .el-table.apply-detail-table .el-table__fixed::-webkit-scrollbar-thumb {
  background: #a8a8a8 !important;
  border-radius: 3px !important;
  border: none !important;
  box-shadow: none !important;
...
.app-container.inWarehouse-refundGoodsApply-page .local-modal-content .modal-detail-section .el-table.apply-detail-table > .el-table__body-wrapper::-webkit-scrollbar-thumb:hover,
.app-container.inWarehouse-refundGoodsApply-page .local-modal-content .modal-detail-section .el-table.apply-detail-table .el-table__fixed-body-wrapper::-webkit-scrollbar-thumb:hover,
.app-container.inWarehouse-refundGoodsApply-page .local-modal-content .modal-detail-section .el-table.apply-detail-table .el-table__fixed-right::-webkit-scrollbar-thumb:hover,
.app-container.inWarehouse-refundGoodsApply-page .local-modal-content .modal-detail-section .el-table.apply-detail-table .el-table__fixed::-webkit-scrollbar-thumb:hover {
  background: #909090 !important;
  border: none !important;
  box-shadow: none !important;
  background-image: none !important;
...
.app-container.inWarehouse-refundGoodsApply-page .local-modal-content .modal-detail-section .apply-detail-table .el-scrollbar__bar.is-vertical {
  width: 6px !important;
}

.app-container.inWarehouse-refundGoodsApply-page .local-modal-content .modal-detail-section .apply-detail-table .el-scrollbar__bar.is-horizontal {
  height: 12px !important;
}

.app-container.inWarehouse-refundGoodsApply-page .local-modal-content .modal-detail-section .apply-detail-table .el-scrollbar__thumb {
...
.app-container.inWarehouse-refundGoodsApply-page .local-modal-content .modal-detail-section .apply-detail-table .el-table__body-wrapper .el-scrollbar__bar,
.app-container.inWarehouse-refundGoodsApply-page .local-modal-content .modal-detail-section .apply-detail-table .el-table__fixed-right .el-scrollbar__bar {
  z-index: 13 !important;
  position: relative;
}

/* 明细表勾选列 sticky：与到货验收主列表一致，避免 fixed 列导致表头全选框/行高亮失效 */
.app-container.inWarehouse-refundGoodsApply-page .local-modal-content .apply-detail-table.el-table {
  position: relative;
}

.app-container.inWarehouse-refundGoodsApply-page .local-modal-content .apply-detail-table th.apply-select-col,
.app-container.inWarehouse-refundGoodsApply-page .local-modal-content .apply-detail-table td.apply-select-col,
.app-container.inWarehouse-refundGoodsApply-page .local-modal-content .apply-detail-table th.el-table-column--selection,
.app-container.inWarehouse-refundGoodsApply-page .local-modal-content .apply-detail-table td.el-table-column--selection {
...
.app-container.inWarehouse-refundGoodsApply-page .local-modal-content .apply-detail-table th.el-table-column--selection .cell,
.app-container.inWarehouse-refundGoodsApply-page .local-modal-content .apply-detail-table th.apply-select-col .cell {
  overflow: visible !important;
}

.app-container.inWarehouse-refundGoodsApply-page .local-modal-content .apply-detail-table th.el-table-column--selection .el-checkbox,
.app-container.inWarehouse-refundGoodsApply-page .local-modal-content .apply-detail-table td.el-table-column--selection .el-checkbox {
 ...
 */
.app-container.inWarehouse-refundGoodsApply-page .local-modal-content .modal-detail-section .el-table .el-table__footer-wrapper,
.app-container.inWarehouse-refundGoodsApply-page .local-modal-content .modal-detail-section .el-table .el-table__fixed .el-table__fixed-footer-wrapper,
.app-container.inWarehouse-refundGoodsApply-page .local-modal-content .modal-detail-section .el-table .el-table__fixed-right .el-table__fixed-footer-wrapper {
...
.app-container.inWarehouse-refundGoodsApply-page .local-modal-content .modal-detail-section .el-table .el-table__fixed-footer-wrapper {
  z-index: 31 !important;
}


/* 弹窗明细表：排序图标与主列表一致 */
.app-container.inWarehouse-refundGoodsApply-page .local-modal-content .apply-detail-table .sort-caret.ascending {
  border-bottom-color: rgba(48, 49, 51, 0.35);
}
.app-container.inWarehouse-refundGoodsApply-page .local-modal-content .apply-detail-table .sort-caret.descending {
  border-top-color: rgba(48, 49, 51, 0.35);
}
.app-container.inWarehouse-refundGoodsApply-page .local-modal-content .apply-detail-table .ascending .sort-caret.ascending {
  border-bottom-color: #2563EB;
}
.app-container.inWarehouse-refundGoodsApply-page .local-modal-content .apply-detail-table .descending .sort-caret.descending {
  border-top-color: #2563EB;
}

/* 弹窗明细表：勾选行高亮（与到货验收主列表一致） */
.app-container.inWarehouse-refundGoodsApply-page .local-modal-content .apply-detail-table .el-table__body tr > td,
.app-container.inWarehouse-refundGoodsApply-page .local-modal-content .apply-detail-table .el-table__body tr > td .cell {
  transition: none !important;
}
.app-container.inWarehouse-refundGoodsApply-page .local-modal-content .apply-detail-table .el-table__body tr:hover > td,
.app-container.inWarehouse-refundGoodsApply-page .local-modal-content .apply-detail-table .el-table__body tr:hover > td .cell,
.app-container.inWarehouse-refundGoodsApply-page .local-modal-content .apply-detail-table .el-table__body tr:hover > td.apply-select-col,
.app-container.inWarehouse-refundGoodsApply-page .local-modal-content .apply-detail-table .el-table__body tr:hover > td.el-table-column--selection {
  background-color: #D6EBFF !important;
}
.app-container.inWarehouse-refundGoodsApply-page .local-modal-content .apply-detail-table .el-table__body tr.apply-row-selected > td,
.app-container.inWarehouse-refundGoodsApply-page .local-modal-content .apply-detail-table .el-table__body tr.apply-row-selected > td .cell {
  background-color: #B8DAFF !important;
}
.app-container.inWarehouse-refundGoodsApply-page .local-modal-content .apply-detail-table .el-table__body tr.apply-row-selected:hover > td,
.app-container.inWarehouse-refundGoodsApply-page .local-modal-content .apply-detail-table .el-table__body tr.apply-row-selected:hover > td .cell,
.app-container.inWarehouse-refundGoodsApply-page .local-modal-content .apply-detail-table .el-table__body tr.apply-row-selected:hover > td.apply-select-col,
.app-container.inWarehouse-refundGoodsApply-page .local-modal-content .apply-detail-table .el-table__body tr.apply-row-selected:hover > td.el-table-column--selection {
  background-color: #A0CBFF !important;
}
.app-container.inWarehouse-refundGoodsApply-page .local-modal-content .apply-detail-table .el-table__body tr.apply-row-selected > td.apply-select-col,
.app-container.inWarehouse-refundGoodsApply-page .local-modal-content .apply-detail-table .el-table__body tr.apply-row-selected > td.el-table-column--selection {
  background-color: #B8DAFF !important;
}
