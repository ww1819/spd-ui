<template>
  <div class="refund-goods-print receipt-print" ref="receiptRefundGoodsPrintRef">
    <div
    ...
    >
      <div class="doc-header">
        <div class="doc-title">
          <span v-if="hospitalName">{{ hospitalName }}</span>退货单
        </div>
        <div class="page-meta">
      ...
      <div class="info-block" :style="tableStyle">
        <div class="info-grid">
          ...
          <div class="info-cell">
            <span class="info-label info-label--col2">供应商</span>
            <span class="info-value">{{ row.supplierName || '' }}</span>
          </div>
          <div class="info-cell">
            <span class="info-label info-label--col3">单号</span>
            <span class="info-value">{{ row.billNo || '' }}</span>
          </div>
          <div class="info-cell">
            <span class="info-label info-label--col1">制单日期</span>
...
export default {
  ...
  methods: {
    ...
    loadPrintSetting() {
      const billType = this.billType || (this.row && this.row.billType) || 301
      ...
      const doPrint = () => {
        this.$nextTick(() => {
          requestAnimationFrame(() => {
            const el = this.$refs.receiptRefundGoodsPrintRef || this.$el
            if (!el) return
