<template>
  <div class="app-container list-page outWarehouse-refundDepotAudit-page">
...
.app-container.outWarehouse-refundDepotAudit-page {
  position: relative;
  display: flex;
  flex-direction: column;
...
.app-container.outWarehouse-refundDepotAudit-page .list-query-panel,
.app-container.outWarehouse-refundDepotAudit-page .list-toolbar {
  flex: 0 0 auto;
}

.app-container.outWarehouse-refundDepotAudit-page .apply-table-panel {
  flex: 1 1 auto;
  min-height: 0;
  display: flex;
  flex-direction: column;
...
.app-container.outWarehouse-refundDepotAudit-page .apply-table-panel > .apply-main-table {
  margin-top: 0;
  flex: 0 0 auto;
...
.app-container.outWarehouse-refundDepotAudit-page .apply-pagination-wrap {
  flex: 0 0 auto;
  border-top: 1px solid #e2e8f0;
}

.app-container.outWarehouse-refundDepotAudit-page .apply-pagination-wrap .pagination-container {
...
.app-container.outWarehouse-refundDepotAudit-page .apply-pagination-wrap .pagination-container .el-pagination {
  position: relative !important;
  right: auto !important;
}

.app-container.outWarehouse-refundDepotAudit-page .apply-main-table .el-table__header-wrapper th,
.app-container.outWarehouse-refundDepotAudit-page .apply-main-table .el-table__header-wrapper th.el-table__cell,
.app-container.outWarehouse-refundDepotAudit-page .apply-main-table .el-table__fixed-header-wrapper th,
.app-container.outWarehouse-refundDepotAudit-page .apply-main-table .el-table__fixed-header-wrapper th.el-table__cell,
.app-container.outWarehouse-refundDepotAudit-page .apply-main-table .el-table__fixed-right-header-wrapper th,
.app-container.outWarehouse-refundDepotAudit-page .apply-main-table .el-table__fixed-right-header-wrapper th.el-table__cell {
...
.app-container.outWarehouse-refundDepotAudit-page .apply-main-table .el-table__header-wrapper th .cell,
.app-container.outWarehouse-refundDepotAudit-page .apply-main-table .el-table__fixed-header-wrapper th .cell,
.app-container.outWarehouse-refundDepotAudit-page .apply-main-table .el-table__fixed-right-header-wrapper th .cell {
  color: #334155 !important;
  font-size: 13px !important;
  font-weight: 600 !important;
...
.app-container.outWarehouse-refundDepotAudit-page .apply-main-table .sort-caret.ascending {
  border-bottom-color: rgba(48, 49, 51, 0.35);
}

.app-container.outWarehouse-refundDepotAudit-page .apply-main-table .sort-caret.descending {
  border-top-color: rgba(48, 49, 51, 0.35);
}

.app-container.outWarehouse-refundDepotAudit-page .apply-main-table .ascending .sort-caret.ascending {
  border-bottom-color: #2563EB;
}

.app-container.outWarehouse-refundDepotAudit-page .apply-main-table .descending .sort-caret.descending {
  border-top-color: #2563EB;
}

.app-container.outWarehouse-refundDepotAudit-page .apply-main-table .col-bill-status .cell {
  white-space: nowrap !important;
}

.app-container.outWarehouse-refundDepotAudit-page .apply-main-table .el-table__body-wrapper {
  z-index: 2;
...
.app-container.outWarehouse-refundDepotAudit-page .apply-main-table .el-table__body-wrapper::-webkit-scrollbar,
.app-container.outWarehouse-refundDepotAudit-page .apply-main-table .el-table__fixed-body-wrapper::-webkit-scrollbar,
.app-container.outWarehouse-refundDepotAudit-page .apply-main-table .el-table__fixed-right::-webkit-scrollbar,
.app-container.outWarehouse-refundDepotAudit-page .apply-main-table .el-table__fixed::-webkit-scrollbar {
  width: 8px !important;
  height: 12px !important;
}

.app-container.outWarehouse-refundDepotAudit-page .apply-main-table .el-table__body-wrapper::-webkit-scrollbar:vertical,
.app-container.outWarehouse-refundDepotAudit-page .apply-main-table .el-table__fixed-body-wrapper::-webkit-scrollbar:vertical,
.app-container.outWarehouse-refundDepotAudit-page .apply-main-table .el-table__fixed-right::-webkit-scrollbar:vertical,
.app-container.outWarehouse-refundDepotAudit-page .apply-main-table .el-table__fixed::-webkit-scrollbar:vertical {
  width: 8px !important;
}

.app-container.outWarehouse-refundDepotAudit-page .apply-main-table .el-table__body-wrapper::-webkit-scrollbar:horizontal,
.app-container.outWarehouse-refundDepotAudit-page .apply-main-table .el-table__fixed-body-wrapper::-webkit-scrollbar:horizontal,
.app-container.outWarehouse-refundDepotAudit-page .apply-main-table .el-table__fixed-right::-webkit-scrollbar:horizontal,
.app-container.outWarehouse-refundDepotAudit-page .apply-main-table .el-table__fixed::-webkit-scrollbar:horizontal {
  height: 12px !important;
}

.app-container.outWarehouse-refundDepotAudit-page .apply-main-table .el-table__body-wrapper::-webkit-scrollbar-track,
.app-container.outWarehouse-refundDepotAudit-page .apply-main-table .el-table__fixed-body-wrapper::-webkit-scrollbar-track,
.app-container.outWarehouse-refundDepotAudit-page .apply-main-table .el-table__fixed-right::-webkit-scrollbar-track,
.app-container.outWarehouse-refundDepotAudit-page .apply-main-table .el-table__fixed::-webkit-scrollbar-track {
  background: #f1f1f1 !important;
  border-radius: 3px !important;
}

.app-container.outWarehouse-refundDepotAudit-page .apply-main-table .el-table__body-wrapper::-webkit-scrollbar-thumb,
.app-container.outWarehouse-refundDepotAudit-page .apply-main-table .el-table__fixed-body-wrapper::-webkit-scrollbar-thumb,
.app-container.outWarehouse-refundDepotAudit-page .apply-main-table .el-table__fixed-right::-webkit-scrollbar-thumb,
.app-container.outWarehouse-refundDepotAudit-page .apply-main-table .el-table__fixed::-webkit-scrollbar-thumb {
...
.app-container.outWarehouse-refundDepotAudit-page .apply-main-table .el-table__body-wrapper::-webkit-scrollbar-thumb:hover,
.app-container.outWarehouse-refundDepotAudit-page .apply-main-table .el-table__fixed-body-wrapper::-webkit-scrollbar-thumb:hover,
.app-container.outWarehouse-refundDepotAudit-page .apply-main-table .el-table__fixed-right::-webkit-scrollbar-thumb:hover,
.app-container.outWarehouse-refundDepotAudit-page .apply-main-table .el-table__fixed::-webkit-scrollbar-thumb:hover {
  background: #909090 !important;
}

.app-container.outWarehouse-refundDepotAudit-page .apply-main-table .el-scrollbar__bar.is-vertical {
  width: 6px !important;
}

.app-container.outWarehouse-refundDepotAudit-page .apply-main-table .el-scrollbar__bar.is-horizontal {
  height: 12px !important;
}

.app-container.outWarehouse-refundDepotAudit-page .apply-main-table.el-table {
  position: relative;
}

.app-container.outWarehouse-refundDepotAudit-page .apply-main-table th.apply-select-col,
.app-container.outWarehouse-refundDepotAudit-page .apply-main-table td.apply-select-col,
.app-container.outWarehouse-refundDepotAudit-page .apply-main-table th.el-table-column--selection,
.app-container.outWarehouse-refundDepotAudit-page .apply-main-table td.el-table-column--selection {
...
.app-container.outWarehouse-refundDepotAudit-page .apply-main-table .el-table__body tr.el-table__row--striped td.apply-select-col,
.app-container.outWarehouse-refundDepotAudit-page .apply-main-table .el-table__body tr.el-table__row--striped td.el-table-column--selection {
  background-color: #fafafa !important;
}

.app-container.outWarehouse-refundDepotAudit-page .apply-main-table th.apply-action-col,
.app-container.outWarehouse-refundDepotAudit-page .apply-main-table td.apply-action-col {
  position: sticky !important;
  z-index: 3;
  box-sizing: border-box !important;
}
...
.app-container.outWarehouse-refundDepotAudit-page .apply-main-table .el-table__body tr.el-table__row--striped td.apply-action-col {
  background-color: #fafafa !important;
}

.app-container.outWarehouse-refundDepotAudit-page .apply-main-table .el-table__body tr > td,
.app-container.outWarehouse-refundDepotAudit-page .apply-main-table .el-table__body tr > td .cell {
  transition: none !important;
}

.app-container.outWarehouse-refundDepotAudit-page .apply-main-table .el-table__body tr:hover > td,
.app-container.outWarehouse-refundDepotAudit-page .apply-main-table .el-table__body tr:hover > td .cell,
.app-container.outWarehouse-refundDepotAudit-page .apply-main-table .el-table__body tr:hover > td.apply-select-col,
.app-container.outWarehouse-refundDepotAudit-page .apply-main-table .el-table__body tr:hover > td.el-table-column--selection,
.app-container.outWarehouse-refundDepotAudit-page .apply-main-table .el-table__body tr:hover > td.apply-action-col {
  background-color: #D6EBFF !important;
}

.app-container.outWarehouse-refundDepotAudit-page .apply-main-table .el-table__body tr.apply-row-selected > td,
.app-container.outWarehouse-refundDepotAudit-page .apply-main-table .el-table__body tr.apply-row-selected > td .cell {
  background-color: #B8DAFF !important;
}

.app-container.outWarehouse-refundDepotAudit-page .apply-main-table .el-table__body tr.apply-row-selected:hover > td,
.app-container.outWarehouse-refundDepotAudit-page .apply-main-table .el-table__body tr.apply-row-selected:hover > td .cell,
.app-container.outWarehouse-refundDepotAudit-page .apply-main-table .el-table__body tr.apply-row-selected:hover > td.apply-select-col,
.app-container.outWarehouse-refundDepotAudit-page .apply-main-table .el-table__body tr.apply-row-selected:hover > td.el-table-column--selection,
.app-container.outWarehouse-refundDepotAudit-page .apply-main-table .el-table__body tr.apply-row-selected:hover > td.apply-action-col {
  background-color: #A0CBFF !important;
}

.app-container.outWarehouse-refundDepotAudit-page .apply-main-table .el-table__body tr.apply-row-selected > td.apply-select-col,
.app-container.outWarehouse-refundDepotAudit-page .apply-main-table .el-table__body tr.apply-row-selected > td.el-table-column--selection,
.app-container.outWarehouse-refundDepotAudit-page .apply-main-table .el-table__body tr.apply-row-selected > td.apply-action-col {
  background-color: #B8DAFF !important;
}

.app-container.outWarehouse-refundDepotAudit-page .apply-main-table .el-table__body tr.el-table__row--striped.apply-row-selected > td.apply-select-col,
.app-container.outWarehouse-refundDepotAudit-page .apply-main-table .el-table__body tr.el-table__row--striped.apply-row-selected > td.el-table-column--selection,
.app-container.outWarehouse-refundDepotAudit-page .apply-main-table .el-table__body tr.el-table__row--striped.apply-row-selected > td.apply-action-col {
  background-color: #B8DAFF !important;
}
