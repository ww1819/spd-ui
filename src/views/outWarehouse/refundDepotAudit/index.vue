<template>
  <div class="app-container list-page refund-depot-audit-page">
...
export default {
  ...
  computed: {
    ...
    moreSearchStorageKey() {
      return "spd.outWarehouse.refundDepotAudit.moreSearchTypes";
    },
  ...
  methods: {
    ...
    getList(allowWhenDialog) {
      ...
      this.applyMoreSearchToQueryParams(baseQuery)
      if (String(status) === '1') {
        Promise.all([
    ...
    moreSearchPlaceholderFor(t) {
      const map = { billNo: '退库单号', refBillNo: '引用单号' };
      return map[t] || '请输入';
    },
...
.app-container.refund-depot-audit-page .local-modal-mask {
  left: -8px;
  right: -8px;
  width: auto;
}
...
.app-container.refund-depot-audit-page > .el-table.table-compact::before,
.app-container.refund-depot-audit-page > .el-table.table-compact::after {
  background-color: #EBEEF5 !important;
}
