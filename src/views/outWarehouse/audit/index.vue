    ...
    <transition name="modal-fade">
      <div v-if="open" class="local-modal-mask">
        ...
        >
          ...
          <el-table-column label="产品编码" align="center" width="130" min-width="120" show-overflow-tooltip resizable sortable>
            <template slot-scope="scope">
    ...
    getList(allowWhenDialog) {
      ...
      listOutWarehouse(baseQuery).then(response => {
        ...
        if (String(status) === '2') {
          ...
          const raw = ti.totalAmt != null ? ti.totalAmt : (ti.totalCkAmt != null ? ti.totalCkAmt : 0)
...
.app-container.outWarehouse-audit-page .apply-pagination-wrap .pagination-summary {
  margin-left: 14px;
  padding-left: 2px;
  font-size: 13px;
  color: #606266;
...
.app-container.outWarehouse-audit-page .apply-pagination-wrap .pagination-summary .summary-label {
  font-weight: 600;
  color: #303133;
}
...
/* 总金额：标签与数值红色 */
.app-container.outWarehouse-audit-page .local-modal-content .apply-modal-header-amount .el-form-item__label {
  color: #f56c6c !important;
}
.app-container.outWarehouse-audit-page .local-modal-content .apply-modal-header-amount .el-input__inner {
  color: #f56c6c !important;
  font-weight: 600;
