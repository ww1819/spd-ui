<template>
  <div class="app-container list-page first-inventory-page">
    ...
    <div class="table-container" ref="tablePanel">
      <el-table
        ref="mainTable"
        class="ctk-department-summary-main-table"
        v-loading="loading"
        :data="pagedList"
        :row-key="getRowKey"
...
export default {
  ...
  methods: {
    ...
    getRowKey(row) {
      ...
      const did = row.departmentId != null && row.departmentId !== '' ? String(row.departmentId) : null;
      const departmentName = (row.departmentName || (row.department && row.department.name) || '').trim() || '未维护科室';
      return did != null ? `id:${did}` : `name:${departmentName}`;
    },
...
/* 表头样式对齐出/退库明细表 */
.first-inventory-page .ctk-department-summary-main-table .el-table__header-wrapper th,
.first-inventory-page .ctk-department-summary-main-table .el-table__header-wrapper th.el-table__cell {
...
.first-inventory-page .ctk-department-summary-main-table .el-table__header th.gutter {
  background-color: #f1f5f9 !important;
}
.first-inventory-page .ctk-department-summary-main-table .el-table__body tr:hover > td {
  background-color: #D6EBFF !important;
}
.first-inventory-page .ctk-department-summary-main-table .el-table__body tr.ctk-row-selected > td {
  background-color: #B8DAFF !important;
}
.first-inventory-page .ctk-department-summary-main-table .el-table__body tr.ctk-row-selected:hover > td {
  background-color: #A0CBFF !important;
}
.first-inventory-page .ctk-department-summary-main-table th.ctk-select-col,
.first-inventory-page .ctk-department-summary-main-table td.ctk-select-col,
.first-inventory-page .ctk-department-summary-main-table th.el-table-column--selection,
.first-inventory-page .ctk-department-summary-main-table td.el-table-column--selection {
  position: sticky;
  left: 0;
  z-index: 2;
...
.first-inventory-page .ctk-department-summary-main-table .el-table__body tr.el-table__row--striped td.ctk-select-col,
.first-inventory-page .ctk-department-summary-main-table .el-table__body tr.el-table__row--striped td.el-table-column--selection {
  background-color: #fafafa;
}
.first-inventory-page .ctk-department-summary-main-table .el-table__body tr:hover > td.ctk-select-col,
.first-inventory-page .ctk-department-summary-main-table .el-table__body tr:hover > td.el-table-column--selection {
  background-color: #D6EBFF;
}
.first-inventory-page .ctk-department-summary-main-table .el-table__body tr.ctk-row-selected > td.ctk-select-col,
.first-inventory-page .ctk-department-summary-main-table .el-table__body tr.ctk-row-selected > td.el-table-column--selection {
  background-color: #B8DAFF;
}
.first-inventory-page .ctk-department-summary-main-table .el-table__body tr.ctk-row-selected:hover > td.ctk-select-col,
.first-inventory-page .ctk-department-summary-main-table .el-table__body tr.ctk-row-selected:hover > td.el-table-column--selection {
