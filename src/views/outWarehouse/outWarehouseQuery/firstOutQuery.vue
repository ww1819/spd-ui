<template>
  <div class="app-container">
    ...
    <el-table v-loading="loading" :data="warehouseList"
      ...
      <el-table-column label="科室" align="center" prop="departmentName" width="120"/>
      <el-table-column label="业务单号" align="center" prop="billNo" width="160" />
      ...
      <el-table-column label="批次" align="center" prop="batchNo" width="200"/>
      <el-table-column label="批号" align="center" prop="batchNumber" width="80"/>
      <el-table-column label="生产日期" align="center" prop="beginDate" width="180">
        <template slot-scope="scope">
          <span>{{ parseTime(scope.row.beginDate, '{y}-{m}-{d}') }}</span>
        </template>
      </el-table-column>
      <el-table-column label="有效期" align="center" prop="endDate" width="180">
        <template slot-scope="scope">
...
export default {
  ...
  methods: {
    ...
    getList() {
      this.loading = true;
      listCTKWarehouse(this.queryParams).then(response => {
