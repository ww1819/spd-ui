...
.app-container.outWarehouse-refundDepotApply-page .apply-pagination-wrap .pagination-summary {
  margin-left: 14px;
  padding-left: 2px;
  font-size: 13px;
  color: #606266;
...
.app-container.outWarehouse-refundDepotApply-page .apply-pagination-wrap .pagination-summary .summary-label {
  font-weight: 600;
  color: #303133;
}
