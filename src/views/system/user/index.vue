          ...
          <el-row>
            <el-col :span="24">
              <el-form-item class="query-item-inline">
                ...
                <el-button type="primary" size="small" :disabled="single" @click="handleUpdate" v-hasPermi="['system:user:edit']" style="margin-left: 10px;">修改</el-button>
                <el-button type="primary" size="small" :disabled="multiple" @click="handleDelete" v-hasPermi="['system:user:remove']" style="margin-left: 10px;">删除</el-button>
                <el-button type="primary" size="small" :disabled="multiple" @click="handleUpdateReferred" v-hasPermi="['system:user:updateReferred']" style="margin-left: 10px;">更新简码</el-button>
                <el-button type="primary" size="small" @click="handleImport" v-hasPermi="['system:user:import']" style="margin-left: 10px;">导入</el-button>
                <el-button type="primary" size="small" @click="handleExport" v-hasPermi="['system:user:export']" style="margin-left: 10px;">导出</el-button>
                <el-button type="primary" size="small" @click="handleQuery" style="margin-left: 10px;">搜索</el-button>
                <el-button type="primary" size="small" @click="resetQuery" style="margin-left: 10px;">重置</el-button>
