<template>
  <div
    v-show="show"
    class="local-modal-mask material-filter-mask ck-apply-select-mask"
    :class="{
      'material-filter-mask--nested': nested,
      'ck-apply-select-full-modal': !nested
    }"
  >
    <div
    ...
    >
      ...
      <el-form
        ...
        label-width="70px"
        size="small"
        class="modal-form-compact material-filter-form ck-apply-select-form"
      ...
      >
        ...
        <el-row :gutter="0" class="list-toolbar apply-modal-toolbar">
          <div class="list-toolbar-left">
            <span class="apply-modal-detail-title">出库单信息</span>
            <el-button
              type="primary"
              size="small"
...
export default {
  ...
  methods: {
    ...
    getList() {
      ...
      this.loading = true
      listOutWarehouse(this.queryParams)
        .then(response => {
    ...
    handleView(row) {
      getOutWarehouse(row.id).then(response => {
...
.ck-apply-select-full-modal.local-modal-mask {
  position: fixed;
  width: 100vw;
  height: 100vh;
...
<style lang="scss">
.ck-apply-select-mask.material-filter-mask--nested {
  position: absolute;
  z-index: 3100;
}

.ck-apply-select-mask.material-filter-mask--nested .local-modal-content.material-filter-modal--nested {
...
.ck-apply-select-mask .material-filter-modal--nested {
  width: 100%;
  height: 100%;
  max-height: 100%;
  min-height: 0;
...
.ck-apply-select-mask.material-filter-mask--nested .apply-inbound-nested-modal > .material-filter-form.modal-form-compact {
...
.ck-apply-select-mask .local-modal-content .apply-modal-query-panel {
  margin-top: 0;
  margin-bottom: 0;
  flex-shrink: 0;
  padding: 6px 8px;
...
.ck-apply-select-mask .local-modal-content .apply-modal-query-panel .apply-modal-form-row.el-row {
  gap: 6px;
  margin-bottom: 4px;
}

.ck-apply-select-mask .local-modal-content .apply-modal-query-panel .apply-modal-form-row.el-row:last-child {
  margin-bottom: 0;
}

.ck-apply-select-mask .local-modal-content .apply-modal-query-panel .apply-modal-form-row .el-form-item {
  margin-bottom: 0;
}

.ck-apply-select-mask .local-modal-content .apply-modal-toolbar.list-toolbar {
  flex: 0 0 auto;
...
.ck-apply-select-mask .local-modal-content .apply-modal-toolbar.list-toolbar .list-toolbar-left {
  display: flex;
  align-items: center;
  flex-wrap: wrap;
}

.ck-apply-select-mask .apply-modal-detail-title {
  margin-right: 12px;
  font-size: 14px;
  font-weight: 600;
  color: #303133;
...
.ck-apply-select-mask.material-filter-mask--nested .material-filter-form.modal-form-compact > .apply-table-panel {
  flex: 1 1 auto;
  min-height: 0;
  margin-bottom: 0;
  display: flex;
...
.ck-apply-select-mask.material-filter-mask--nested .apply-table-panel > .apply-main-table {
  margin-top: 0;
  flex: 0 0 auto;
...
.ck-apply-select-mask.material-filter-mask--nested .apply-table-panel .apply-pagination-wrap {
  flex: 0 0 auto;
...
.ck-apply-select-mask.material-filter-mask--nested .apply-table-panel .apply-pagination-wrap .pagination-container {
  padding: 0 !important;
  margin: 0 !important;
  background: transparent;
}

.ck-apply-select-mask.material-filter-mask--nested .apply-table-panel > .apply-main-table > .el-table__body-wrapper {
