<template>
  <div
    v-show="show"
    class="local-modal-mask material-filter-mask d-apply-select-mask"
    :class="{
      'material-filter-mask--nested': nested,
      'd-apply-select-full-modal': !nested
    }"
  >
    <div
    ...
    >
      ...
      <el-form
        ...
        label-width="84px"
        size="small"
        class="modal-form-compact material-filter-form d-apply-select-form"
      ...
      >
        <div class="form-fields-container list-query-panel apply-modal-query-panel">
          <el-row :gutter="0" class="apply-modal-form-row apply-modal-row-first" type="flex">
            <el-col class="apply-modal-field apply-modal-field--standard">
              <el-form-item label="仓库申请单号" prop="applyBillNo" label-width="96px">
                <el-input
            ...
            <el-col class="apply-modal-field apply-modal-field--standard">
              <el-form-item label="科室申领单号" prop="basApplyBillNo" label-width="96px">
                <el-input
        ...
        <el-row :gutter="0" class="list-toolbar apply-modal-toolbar">
          <div class="list-toolbar-left">
            <span class="apply-modal-detail-title">仓库申请单信息</span>
            <el-button
              type="primary"
              size="small"
        ...
        >
          ...
          >
            ...
            <el-table-column
              ...
              resizable
              sortable
              :sort-method="(a, b) => sortByStr(a, b, 'applyBillNo')"
            >
            ...
            <el-table-column
              ...
              resizable
              sortable
              :sort-method="(a, b) => sortByStr(a, b, 'basApplyBillNo')"
            />
            ...
            <el-table-column
              label="审核日期"
              align="center"
              prop="sourceAuditDate"
              width="120"
              show-overflow-tooltip
              resizable
              sortable
              :sort-method="(a, b) => sortByDate(a, b, 'sourceAuditDate')"
            >
              <template slot-scope="scope">
...
.d-apply-select-full-modal.local-modal-mask {
  left: -8px;
  right: -8px;
  width: auto;
  z-index: 1100;
...
<style lang="scss">
.d-apply-select-mask.material-filter-mask--nested {
  position: absolute;
  z-index: 3100;
}

.d-apply-select-mask.material-filter-mask--nested .local-modal-content.material-filter-modal--nested {
...
.d-apply-select-mask .material-filter-modal--nested {
  width: 100%;
  height: 100%;
  max-height: 100%;
  min-height: 0;
...
.d-apply-select-mask.material-filter-mask--nested .apply-inbound-nested-modal > .material-filter-form.modal-form-compact {
...
.d-apply-select-mask .local-modal-content .apply-modal-query-panel {
  margin-top: 0;
  margin-bottom: 0;
  flex-shrink: 0;
  padding: 6px 8px;
...
.d-apply-select-mask .local-modal-content .apply-modal-query-panel .apply-modal-form-row.el-row {
  gap: 6px;
  margin-bottom: 4px;
}

.d-apply-select-mask .local-modal-content .apply-modal-query-panel .apply-modal-form-row .el-form-item {
  margin-bottom: 0;
}

.d-apply-select-mask .local-modal-content .apply-modal-toolbar.list-toolbar {
  flex: 0 0 auto;
...
.d-apply-select-mask .local-modal-content .apply-modal-toolbar.list-toolbar .list-toolbar-left {
  display: flex;
  align-items: center;
  flex-wrap: wrap;
}

.d-apply-select-mask .apply-modal-detail-title {
  margin-right: 12px;
  font-size: 14px;
  font-weight: 600;
  color: #303133;
...
.d-apply-select-mask.material-filter-mask--nested .material-filter-form.modal-form-compact > .apply-table-panel {
  flex: 1 1 auto;
  min-height: 0;
  margin-bottom: 0;
  display: flex;
...
.d-apply-select-mask.material-filter-mask--nested .apply-table-panel > .apply-main-table {
  margin-top: 0;
  flex: 0 0 auto;
...
.d-apply-select-mask.material-filter-mask--nested .apply-table-panel .apply-pagination-wrap {
  flex: 0 0 auto;
...
.d-apply-select-mask.material-filter-mask--nested .apply-table-panel .apply-pagination-wrap .pagination-container {
  padding: 0 !important;
  margin: 0 !important;
  background: transparent;
}

.d-apply-select-mask.material-filter-mask--nested .apply-table-panel > .apply-main-table > .el-table__body-wrapper {
